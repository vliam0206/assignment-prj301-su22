...
//    private final String ERROR_PAGE = "errorsPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String urlRewriting = siteMaps.getProperty(MyAppConstants.UpdateAccFeatures.ERROR_PAGE);
        ...
        try {
            ...
            //2. process result
            if (result) { // update thanh cong -> goi lai trang search
